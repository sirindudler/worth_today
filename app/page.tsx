      ...
      <div className="max-w-5xl mx-auto px-8 py-16">
        ...
        <footer className="mt-16 pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Ko-fi */}
            <a
              href="https://ko-fi.com/sirindudler"
              target="_blank"
              rel="noopener noreferrer"
              style={{ background: '#FF5E5B', borderRadius: '4px', display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '4px 10px', textDecoration: 'none' }}
            >
              ...
              <span style={{ color: '#fff', fontSize: '12px', fontWeight: 600, whiteSpace: 'nowrap' }}>Support me</span>
            </a>
          </div>
        </footer>
      </div>
